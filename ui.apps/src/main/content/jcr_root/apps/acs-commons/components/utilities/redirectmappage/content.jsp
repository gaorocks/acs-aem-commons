...
<div ng-controller="MainCtrl" ng-init="app.uri = '${resourcePath}'; init();">
    ...
    <coral-tabview>
        <coral-tablist target="main-panel-1">
            ...
            <coral-tab><fmt:message key="View Entries" /></coral-tab>
            <coral-tab><fmt:message key="Download" /></coral-tab>
        </coral-tablist>
        <coral-panelstack id="main-panel-1">
            ...
            <coral-panel class="coral-Well">
                <section>
                    ...
                    <p>
                        <fmt:message key="Select Find Entries to load a list of the entries in the redirect map files and gathered from the configuration. Click the button to edit." />
                    </p>
            ...
            <coral-panel class="coral-Well">
                <section>
                    <h2 class="coral-Heading coral-Heading--2"><fmt:message key="Download Report" /></h2>
                    <a class="coral-Link" href="${resource.path}.redirectmap.txt" download="vanity-url-report.csv">
                        <fmt:message key="Download Vanity URL Report (CSV)" />
                    </a>
                </section>
                <section>
